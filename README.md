...
<!-- LANGUAGES -->
<div style="background-color: #fff7e6; padding: 15px; border-radius: 12px; margin-bottom: 15px;">
  <h3>👩‍💻 Languages</h3>
...
<!-- AI/ML -->
<div style="background-color: #ffe6e6; padding: 15px; border-radius: 12px; margin-bottom: 15px;">
  <h3>🤖 AI/ML</h3>
...
<!-- DATA SCIENCE -->
<div style="background-color: #e6f0ff; padding: 15px; border-radius: 12px; margin-bottom: 15px;">
  <h3>📊 Data Science</h3>
...
<!-- CLOUD & DEVOPS -->
<div style="background-color: #e6faff; padding: 15px; border-radius: 12px; margin-bottom: 15px;">
...
<!-- DATABASES -->
<div style="background-color: #ebfaeb; padding: 15px; border-radius: 12px; margin-bottom: 15px;">
  <h3>🗄️ Databases</h3>
...
<!-- TOOLS -->
<div style="background-color: #fce6ff; padding: 15px; border-radius: 12px; margin-bottom: 15px;">
